            ...
            <React.Fragment>
              <TippyToolTip content="Messages" placement="bottom">
                <button className={cx('button')}>
                  <svg width="30" height="36" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
          ...
          <Menu items={isLoggedIn ? LOGGED_MENU_ITEMS : BASE_MENU_ITEMS} onChange={handleMenuChange}>
            {isLoggedIn ? (
              <div className={cx('avatar')}>
                <img
                  src="https://p16-sign-sg.tiktokcdn.com/aweme/720x720/tiktok-obj/1682072296970242.jpeg?x-expires=1661457600&x-signature=K6VcHyMKANk6XK1mS%2Fy%2BtCste1A%3D"
                  alt="avatar"
                />
              </div>
            ) : (
